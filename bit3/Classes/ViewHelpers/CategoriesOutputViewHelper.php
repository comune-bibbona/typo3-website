...
class CategoriesOutputViewHelper extends AbstractViewHelper implements ViewHelperInterface
{
	...
	public function render()
	{
		 ...
		 */
		$queryBuilder->select('sys_category.uid', 'sys_category.parent', 'sys_category.title', 'sys_category.slug', 'sys_category.single_pid', 'sys_category.shortcut', 'sys_category_record_mm.uid_foreign', 'sys_category_record_mm.tablenames');
