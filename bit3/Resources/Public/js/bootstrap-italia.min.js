(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@popperjs/core'), require('animejs/lib/anime.es.js'), require('@splidejs/splide'), require('masonry-layout'), require('accessible-autocomplete')) :
    typeof define === 'function' && define.amd ? define(['@popperjs/core', 'animejs/lib/anime.es.js', '@splidejs/splide', 'masonry-layout', 'accessible-autocomplete'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.bootstrap = factory(global.Popper, global.anime, global.Splide, global.MasonryPlugin, global.accessibleAutocomplete));
})(this, (function (Popper, anime, Splide, MasonryPlugin, accessibleAutocomplete) { 'use strict';
    ...
    const NAME$q="selectautocomplete";class SelectAutocomplete extends BaseComponent{constructor(e,t){super(e),this._config=t,this._enhance();}static get NAME(){return NAME$q}_enhance(){accessibleAutocomplete__default.default.enhanceSelectElement(Object.assign({},{selectElement:this._element},this._config));}}const SelectAutocomplete$1 = SelectAutocomplete;
