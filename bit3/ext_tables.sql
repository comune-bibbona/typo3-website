...
#
# Table structure for table 'tx_bit3_feedback_data'
#
CREATE TABLE tx_bit3_feedback_data (
   uid int(11) unsigned NOT NULL auto_increment,
   pid int(11) DEFAULT '0' NOT NULL,

   clarity_rating VARCHAR(255) DEFAULT NULL,
   difficulty_area VARCHAR(255) DEFAULT NULL,
   preferred_aspects VARCHAR(255) DEFAULT NULL,
